...
<body class="bg-gray-100 flex justify-center items-center h-screen">
    ...
    <script>
        ...
        function sendImageData(imageData) {
            ...
            xhr.open("POST", "controllers/save_image.php", true);
        ...
        continueButton.onclick = function() {
            window.opener.document.getElementById('capturedImage').innerHTML = '<img src="' + photo.src + '" alt="Captured Image"/>'; 
            window.close();
        };
        ...
        document.getElementById('capture').addEventListener('click', function() {
            ...
            window.opener.document.getElementById('imagePath').value = imageData;

            window.opener.document.getElementById('capturedImage').innerHTML = '<img src="' + imageData + '" alt="Captured Image"/>';
